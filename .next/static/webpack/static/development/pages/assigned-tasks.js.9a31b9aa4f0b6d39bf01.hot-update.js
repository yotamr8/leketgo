        ...
        case 'tasks':
          ...
          if (entry.collected) {
            if (entry.reportFilled) {
              ...
              _statusMessage = 'האיסוף בוצע והמשוב מולא';
            } else {
              statusIcon = 'far fa-calendar-check';
              _statusMessage = 'האיסוף בוצע אך המשוב לא מולא';
            }
          } else {
            if (entry.reportFilled) {
              statusIcon = 'fas fa-calendar-times';
              _statusMessage = 'האיסוף לא בוצע והמשוב מולא';
            } else {
              statusIcon = 'far fa-calendar-times';
              _statusMessage = 'האיסוף לא בוצע והמשוב לא מולא';
            }
          }
          ...
          default:
            {
              return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("td", {
                ...
                __self: this
              }, _this2.getDataValues(_this2.props.entry)[statusMessage]);
            }
        }
      }));
    }
...
//# sourceMappingURL=assigned-tasks.js.9a31b9aa4f0b6d39bf01.hot-update.js.map