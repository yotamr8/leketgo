        ...
        case 'REMOVE_USER':
          {
            ...
            body = 'איפוס הסיסמה למתנדב ${user.firstName} ${user.lastName}: מתנדב שנמחק מהמערכת לא יוכל להתחבר. תיעוד הפעילות שלו יישמר וניתן יהיה להפעיל מחדש את המשתמש.';
            buttons = [{
              onClick: function onClick() {
                Object(_dbActions_setUndoTask__WEBPACK_IMPORTED_MODULE_12__["default"])(modal.entries.id);
...
//# sourceMappingURL=_app.js.40108e4bced80084c98d.hot-update.js.map